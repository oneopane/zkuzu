...
pub const struct_ArrowSchema = extern struct {
    ...
    metadata: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    flags: i64 = @import("std").mem.zeroes(i64),
    n_children: i64 = @import("std").mem.zeroes(i64),
    children: [*c][*c]struct_ArrowSchema = @import("std").mem.zeroes([*c][*c]struct_ArrowSchema),
    dictionary: [*c]struct_ArrowSchema = @import("std").mem.zeroes([*c]struct_ArrowSchema),
    release: ?*const fn ([*c]struct_ArrowSchema) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]struct_ArrowSchema) callconv(.c) void),
    private_data: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const struct_ArrowArray = extern struct {
    length: i64 = @import("std").mem.zeroes(i64),
    null_count: i64 = @import("std").mem.zeroes(i64),
    offset: i64 = @import("std").mem.zeroes(i64),
    n_buffers: i64 = @import("std").mem.zeroes(i64),
    n_children: i64 = @import("std").mem.zeroes(i64),
    buffers: [*c]?*const anyopaque = @import("std").mem.zeroes([*c]?*const anyopaque),
    children: [*c][*c]struct_ArrowArray = @import("std").mem.zeroes([*c][*c]struct_ArrowArray),
    dictionary: [*c]struct_ArrowArray = @import("std").mem.zeroes([*c]struct_ArrowArray),
    release: ?*const fn ([*c]struct_ArrowArray) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]struct_ArrowArray) callconv(.c) void),
    private_data: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const kuzu_system_config = extern struct {
    buffer_pool_size: u64 = @import("std").mem.zeroes(u64),
    max_num_threads: u64 = @import("std").mem.zeroes(u64),
    enable_compression: bool = @import("std").mem.zeroes(bool),
    read_only: bool = @import("std").mem.zeroes(bool),
    max_db_size: u64 = @import("std").mem.zeroes(u64),
    auto_checkpoint: bool = @import("std").mem.zeroes(bool),
    checkpoint_threshold: u64 = @import("std").mem.zeroes(u64),
    thread_qos: u32 = @import("std").mem.zeroes(u32),
};
pub const kuzu_database = extern struct {
    _database: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const kuzu_connection = extern struct {
    _connection: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const kuzu_prepared_statement = extern struct {
    _prepared_statement: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    _bound_values: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const kuzu_query_result = extern struct {
    _query_result: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    _is_owned_by_cpp: bool = @import("std").mem.zeroes(bool),
};
pub const kuzu_flat_tuple = extern struct {
    _flat_tuple: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    _is_owned_by_cpp: bool = @import("std").mem.zeroes(bool),
};
pub const kuzu_logical_type = extern struct {
    _data_type: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const kuzu_value = extern struct {
    _value: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    _is_owned_by_cpp: bool = @import("std").mem.zeroes(bool),
};
pub const kuzu_internal_id_t = extern struct {
    table_id: u64 = @import("std").mem.zeroes(u64),
    offset: u64 = @import("std").mem.zeroes(u64),
};
pub const kuzu_date_t = extern struct {
    days: i32 = @import("std").mem.zeroes(i32),
};
pub const kuzu_timestamp_ns_t = extern struct {
    value: i64 = @import("std").mem.zeroes(i64),
};
pub const kuzu_timestamp_ms_t = extern struct {
    value: i64 = @import("std").mem.zeroes(i64),
};
pub const kuzu_timestamp_sec_t = extern struct {
    value: i64 = @import("std").mem.zeroes(i64),
};
pub const kuzu_timestamp_tz_t = extern struct {
    value: i64 = @import("std").mem.zeroes(i64),
};
pub const kuzu_timestamp_t = extern struct {
    value: i64 = @import("std").mem.zeroes(i64),
};
pub const kuzu_interval_t = extern struct {
    months: i32 = @import("std").mem.zeroes(i32),
    days: i32 = @import("std").mem.zeroes(i32),
    micros: i64 = @import("std").mem.zeroes(i64),
};
pub const kuzu_query_summary = extern struct {
    _query_summary: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const kuzu_int128_t = extern struct {
    low: u64 = @import("std").mem.zeroes(u64),
    high: i64 = @import("std").mem.zeroes(i64),
};
pub const KUZU_ANY: c_int = 0;
pub const KUZU_NODE: c_int = 10;
pub const KUZU_REL: c_int = 11;
pub const KUZU_RECURSIVE_REL: c_int = 12;
pub const KUZU_SERIAL: c_int = 13;
pub const KUZU_BOOL: c_int = 22;
pub const KUZU_INT64: c_int = 23;
pub const KUZU_INT32: c_int = 24;
pub const KUZU_INT16: c_int = 25;
pub const KUZU_INT8: c_int = 26;
pub const KUZU_UINT64: c_int = 27;
pub const KUZU_UINT32: c_int = 28;
pub const KUZU_UINT16: c_int = 29;
pub const KUZU_UINT8: c_int = 30;
pub const KUZU_INT128: c_int = 31;
pub const KUZU_DOUBLE: c_int = 32;
pub const KUZU_FLOAT: c_int = 33;
pub const KUZU_DATE: c_int = 34;
pub const KUZU_TIMESTAMP: c_int = 35;
pub const KUZU_TIMESTAMP_SEC: c_int = 36;
pub const KUZU_TIMESTAMP_MS: c_int = 37;
pub const KUZU_TIMESTAMP_NS: c_int = 38;
pub const KUZU_TIMESTAMP_TZ: c_int = 39;
pub const KUZU_INTERVAL: c_int = 40;
pub const KUZU_DECIMAL: c_int = 41;
pub const KUZU_INTERNAL_ID: c_int = 42;
pub const KUZU_STRING: c_int = 50;
pub const KUZU_BLOB: c_int = 51;
pub const KUZU_LIST: c_int = 52;
pub const KUZU_ARRAY: c_int = 53;
pub const KUZU_STRUCT: c_int = 54;
pub const KUZU_MAP: c_int = 55;
pub const KUZU_UNION: c_int = 56;
pub const KUZU_POINTER: c_int = 58;
pub const KUZU_UUID: c_int = 59;
pub const kuzu_data_type_id = c_uint;
pub const KuzuSuccess: c_int = 0;
pub const KuzuError: c_int = 1;
pub const kuzu_state = c_uint;
pub extern fn kuzu_database_init(database_path: [*c]const u8, system_config: kuzu_system_config, out_database: [*c]kuzu_database) kuzu_state;
pub extern fn kuzu_database_destroy(database: [*c]kuzu_database) void;
pub extern fn kuzu_default_system_config(...) kuzu_system_config;
pub extern fn kuzu_connection_init(database: [*c]kuzu_database, out_connection: [*c]kuzu_connection) kuzu_state;
pub extern fn kuzu_connection_destroy(connection: [*c]kuzu_connection) void;
pub extern fn kuzu_connection_set_max_num_thread_for_exec(connection: [*c]kuzu_connection, num_threads: u64) kuzu_state;
pub extern fn kuzu_connection_get_max_num_thread_for_exec(connection: [*c]kuzu_connection, out_result: [*c]u64) kuzu_state;
pub extern fn kuzu_connection_query(connection: [*c]kuzu_connection, query: [*c]const u8, out_query_result: [*c]kuzu_query_result) kuzu_state;
pub extern fn kuzu_connection_prepare(connection: [*c]kuzu_connection, query: [*c]const u8, out_prepared_statement: [*c]kuzu_prepared_statement) kuzu_state;
pub extern fn kuzu_connection_execute(connection: [*c]kuzu_connection, prepared_statement: [*c]kuzu_prepared_statement, out_query_result: [*c]kuzu_query_result) kuzu_state;
pub extern fn kuzu_connection_interrupt(connection: [*c]kuzu_connection) void;
pub extern fn kuzu_connection_set_query_timeout(connection: [*c]kuzu_connection, timeout_in_ms: u64) kuzu_state;
pub extern fn kuzu_prepared_statement_destroy(prepared_statement: [*c]kuzu_prepared_statement) void;
pub extern fn kuzu_prepared_statement_is_success(prepared_statement: [*c]kuzu_prepared_statement) bool;
pub extern fn kuzu_prepared_statement_get_error_message(prepared_statement: [*c]kuzu_prepared_statement) [*c]u8;
pub extern fn kuzu_prepared_statement_bind_bool(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: bool) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_int64(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: i64) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_int32(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: i32) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_int16(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: i16) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_int8(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: i8) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_uint64(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: u64) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_uint32(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: u32) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_uint16(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: u16) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_uint8(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: u8) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_double(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: f64) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_float(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: f32) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_date(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: kuzu_date_t) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_timestamp_ns(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: kuzu_timestamp_ns_t) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_timestamp_sec(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: kuzu_timestamp_sec_t) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_timestamp_tz(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: kuzu_timestamp_tz_t) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_timestamp_ms(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: kuzu_timestamp_ms_t) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_timestamp(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: kuzu_timestamp_t) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_interval(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: kuzu_interval_t) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_string(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: [*c]const u8) kuzu_state;
pub extern fn kuzu_prepared_statement_bind_value(prepared_statement: [*c]kuzu_prepared_statement, param_name: [*c]const u8, value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_query_result_destroy(query_result: [*c]kuzu_query_result) void;
pub extern fn kuzu_query_result_is_success(query_result: [*c]kuzu_query_result) bool;
pub extern fn kuzu_query_result_get_error_message(query_result: [*c]kuzu_query_result) [*c]u8;
pub extern fn kuzu_query_result_get_num_columns(query_result: [*c]kuzu_query_result) u64;
pub extern fn kuzu_query_result_get_column_name(query_result: [*c]kuzu_query_result, index: u64, out_column_name: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_query_result_get_column_data_type(query_result: [*c]kuzu_query_result, index: u64, out_column_data_type: [*c]kuzu_logical_type) kuzu_state;
pub extern fn kuzu_query_result_get_num_tuples(query_result: [*c]kuzu_query_result) u64;
pub extern fn kuzu_query_result_get_query_summary(query_result: [*c]kuzu_query_result, out_query_summary: [*c]kuzu_query_summary) kuzu_state;
pub extern fn kuzu_query_result_has_next(query_result: [*c]kuzu_query_result) bool;
pub extern fn kuzu_query_result_get_next(query_result: [*c]kuzu_query_result, out_flat_tuple: [*c]kuzu_flat_tuple) kuzu_state;
pub extern fn kuzu_query_result_has_next_query_result(query_result: [*c]kuzu_query_result) bool;
pub extern fn kuzu_query_result_get_next_query_result(query_result: [*c]kuzu_query_result, out_next_query_result: [*c]kuzu_query_result) kuzu_state;
pub extern fn kuzu_query_result_to_string(query_result: [*c]kuzu_query_result) [*c]u8;
pub extern fn kuzu_query_result_reset_iterator(query_result: [*c]kuzu_query_result) void;
pub extern fn kuzu_query_result_get_arrow_schema(query_result: [*c]kuzu_query_result, out_schema: [*c]struct_ArrowSchema) kuzu_state;
pub extern fn kuzu_query_result_get_next_arrow_chunk(query_result: [*c]kuzu_query_result, chunk_size: i64, out_arrow_array: [*c]struct_ArrowArray) kuzu_state;
pub extern fn kuzu_flat_tuple_destroy(flat_tuple: [*c]kuzu_flat_tuple) void;
pub extern fn kuzu_flat_tuple_get_value(flat_tuple: [*c]kuzu_flat_tuple, index: u64, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_flat_tuple_to_string(flat_tuple: [*c]kuzu_flat_tuple) [*c]u8;
pub extern fn kuzu_data_type_create(id: kuzu_data_type_id, child_type: [*c]kuzu_logical_type, num_elements_in_array: u64, out_type: [*c]kuzu_logical_type) void;
pub extern fn kuzu_data_type_clone(data_type: [*c]kuzu_logical_type, out_type: [*c]kuzu_logical_type) void;
pub extern fn kuzu_data_type_destroy(data_type: [*c]kuzu_logical_type) void;
pub extern fn kuzu_data_type_equals(data_type1: [*c]kuzu_logical_type, data_type2: [*c]kuzu_logical_type) bool;
pub extern fn kuzu_data_type_get_id(data_type: [*c]kuzu_logical_type) kuzu_data_type_id;
pub extern fn kuzu_data_type_get_num_elements_in_array(data_type: [*c]kuzu_logical_type, out_result: [*c]u64) kuzu_state;
pub extern fn kuzu_value_create_null(...) [*c]kuzu_value;
pub extern fn kuzu_value_create_null_with_data_type(data_type: [*c]kuzu_logical_type) [*c]kuzu_value;
pub extern fn kuzu_value_is_null(value: [*c]kuzu_value) bool;
pub extern fn kuzu_value_set_null(value: [*c]kuzu_value, is_null: bool) void;
pub extern fn kuzu_value_create_default(data_type: [*c]kuzu_logical_type) [*c]kuzu_value;
pub extern fn kuzu_value_create_bool(val_: bool) [*c]kuzu_value;
pub extern fn kuzu_value_create_int8(val_: i8) [*c]kuzu_value;
pub extern fn kuzu_value_create_int16(val_: i16) [*c]kuzu_value;
pub extern fn kuzu_value_create_int32(val_: i32) [*c]kuzu_value;
pub extern fn kuzu_value_create_int64(val_: i64) [*c]kuzu_value;
pub extern fn kuzu_value_create_uint8(val_: u8) [*c]kuzu_value;
pub extern fn kuzu_value_create_uint16(val_: u16) [*c]kuzu_value;
pub extern fn kuzu_value_create_uint32(val_: u32) [*c]kuzu_value;
pub extern fn kuzu_value_create_uint64(val_: u64) [*c]kuzu_value;
pub extern fn kuzu_value_create_int128(val_: kuzu_int128_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_float(val_: f32) [*c]kuzu_value;
pub extern fn kuzu_value_create_double(val_: f64) [*c]kuzu_value;
pub extern fn kuzu_value_create_internal_id(val_: kuzu_internal_id_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_date(val_: kuzu_date_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_timestamp_ns(val_: kuzu_timestamp_ns_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_timestamp_ms(val_: kuzu_timestamp_ms_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_timestamp_sec(val_: kuzu_timestamp_sec_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_timestamp_tz(val_: kuzu_timestamp_tz_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_timestamp(val_: kuzu_timestamp_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_interval(val_: kuzu_interval_t) [*c]kuzu_value;
pub extern fn kuzu_value_create_string(val_: [*c]const u8) [*c]kuzu_value;
pub extern fn kuzu_value_create_list(num_elements: u64, elements: [*c][*c]kuzu_value, out_value: [*c][*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_create_struct(num_fields: u64, field_names: [*c][*c]const u8, field_values: [*c][*c]kuzu_value, out_value: [*c][*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_create_map(num_fields: u64, keys: [*c][*c]kuzu_value, values: [*c][*c]kuzu_value, out_value: [*c][*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_clone(value: [*c]kuzu_value) [*c]kuzu_value;
pub extern fn kuzu_value_copy(value: [*c]kuzu_value, other: [*c]kuzu_value) void;
pub extern fn kuzu_value_destroy(value: [*c]kuzu_value) void;
pub extern fn kuzu_value_get_list_size(value: [*c]kuzu_value, out_result: [*c]u64) kuzu_state;
pub extern fn kuzu_value_get_list_element(value: [*c]kuzu_value, index: u64, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_get_struct_num_fields(value: [*c]kuzu_value, out_result: [*c]u64) kuzu_state;
pub extern fn kuzu_value_get_struct_field_name(value: [*c]kuzu_value, index: u64, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_value_get_struct_field_value(value: [*c]kuzu_value, index: u64, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_get_map_size(value: [*c]kuzu_value, out_result: [*c]u64) kuzu_state;
pub extern fn kuzu_value_get_map_key(value: [*c]kuzu_value, index: u64, out_key: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_get_map_value(value: [*c]kuzu_value, index: u64, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_get_recursive_rel_node_list(value: [*c]kuzu_value, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_get_recursive_rel_rel_list(value: [*c]kuzu_value, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_value_get_data_type(value: [*c]kuzu_value, out_type: [*c]kuzu_logical_type) void;
pub extern fn kuzu_value_get_bool(value: [*c]kuzu_value, out_result: [*c]bool) kuzu_state;
pub extern fn kuzu_value_get_int8(value: [*c]kuzu_value, out_result: [*c]i8) kuzu_state;
pub extern fn kuzu_value_get_int16(value: [*c]kuzu_value, out_result: [*c]i16) kuzu_state;
pub extern fn kuzu_value_get_int32(value: [*c]kuzu_value, out_result: [*c]i32) kuzu_state;
pub extern fn kuzu_value_get_int64(value: [*c]kuzu_value, out_result: [*c]i64) kuzu_state;
pub extern fn kuzu_value_get_uint8(value: [*c]kuzu_value, out_result: [*c]u8) kuzu_state;
pub extern fn kuzu_value_get_uint16(value: [*c]kuzu_value, out_result: [*c]u16) kuzu_state;
pub extern fn kuzu_value_get_uint32(value: [*c]kuzu_value, out_result: [*c]u32) kuzu_state;
pub extern fn kuzu_value_get_uint64(value: [*c]kuzu_value, out_result: [*c]u64) kuzu_state;
pub extern fn kuzu_value_get_int128(value: [*c]kuzu_value, out_result: [*c]kuzu_int128_t) kuzu_state;
pub extern fn kuzu_int128_t_from_string(str: [*c]const u8, out_result: [*c]kuzu_int128_t) kuzu_state;
pub extern fn kuzu_int128_t_to_string(val: kuzu_int128_t, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_value_get_float(value: [*c]kuzu_value, out_result: [*c]f32) kuzu_state;
pub extern fn kuzu_value_get_double(value: [*c]kuzu_value, out_result: [*c]f64) kuzu_state;
pub extern fn kuzu_value_get_internal_id(value: [*c]kuzu_value, out_result: [*c]kuzu_internal_id_t) kuzu_state;
pub extern fn kuzu_value_get_date(value: [*c]kuzu_value, out_result: [*c]kuzu_date_t) kuzu_state;
pub extern fn kuzu_value_get_timestamp(value: [*c]kuzu_value, out_result: [*c]kuzu_timestamp_t) kuzu_state;
pub extern fn kuzu_value_get_timestamp_ns(value: [*c]kuzu_value, out_result: [*c]kuzu_timestamp_ns_t) kuzu_state;
pub extern fn kuzu_value_get_timestamp_ms(value: [*c]kuzu_value, out_result: [*c]kuzu_timestamp_ms_t) kuzu_state;
pub extern fn kuzu_value_get_timestamp_sec(value: [*c]kuzu_value, out_result: [*c]kuzu_timestamp_sec_t) kuzu_state;
pub extern fn kuzu_value_get_timestamp_tz(value: [*c]kuzu_value, out_result: [*c]kuzu_timestamp_tz_t) kuzu_state;
pub extern fn kuzu_value_get_interval(value: [*c]kuzu_value, out_result: [*c]kuzu_interval_t) kuzu_state;
pub extern fn kuzu_value_get_decimal_as_string(value: [*c]kuzu_value, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_value_get_string(value: [*c]kuzu_value, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_value_get_blob(value: [*c]kuzu_value, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_value_get_uuid(value: [*c]kuzu_value, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_value_to_string(value: [*c]kuzu_value) [*c]u8;
pub extern fn kuzu_node_val_get_id_val(node_val: [*c]kuzu_value, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_node_val_get_label_val(node_val: [*c]kuzu_value, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_node_val_get_property_size(node_val: [*c]kuzu_value, out_value: [*c]u64) kuzu_state;
pub extern fn kuzu_node_val_get_property_name_at(node_val: [*c]kuzu_value, index: u64, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_node_val_get_property_value_at(node_val: [*c]kuzu_value, index: u64, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_node_val_to_string(node_val: [*c]kuzu_value, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_rel_val_get_id_val(rel_val: [*c]kuzu_value, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_rel_val_get_src_id_val(rel_val: [*c]kuzu_value, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_rel_val_get_dst_id_val(rel_val: [*c]kuzu_value, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_rel_val_get_label_val(rel_val: [*c]kuzu_value, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_rel_val_get_property_size(rel_val: [*c]kuzu_value, out_value: [*c]u64) kuzu_state;
pub extern fn kuzu_rel_val_get_property_name_at(rel_val: [*c]kuzu_value, index: u64, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_rel_val_get_property_value_at(rel_val: [*c]kuzu_value, index: u64, out_value: [*c]kuzu_value) kuzu_state;
pub extern fn kuzu_rel_val_to_string(rel_val: [*c]kuzu_value, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_destroy_string(str: [*c]u8) void;
pub extern fn kuzu_destroy_blob(blob: [*c]u8) void;
pub extern fn kuzu_query_summary_destroy(query_summary: [*c]kuzu_query_summary) void;
pub extern fn kuzu_query_summary_get_compiling_time(query_summary: [*c]kuzu_query_summary) f64;
pub extern fn kuzu_query_summary_get_execution_time(query_summary: [*c]kuzu_query_summary) f64;
pub extern fn kuzu_timestamp_ns_to_tm(timestamp: kuzu_timestamp_ns_t, out_result: [*c]struct_tm) kuzu_state;
pub extern fn kuzu_timestamp_ms_to_tm(timestamp: kuzu_timestamp_ms_t, out_result: [*c]struct_tm) kuzu_state;
pub extern fn kuzu_timestamp_sec_to_tm(timestamp: kuzu_timestamp_sec_t, out_result: [*c]struct_tm) kuzu_state;
pub extern fn kuzu_timestamp_tz_to_tm(timestamp: kuzu_timestamp_tz_t, out_result: [*c]struct_tm) kuzu_state;
pub extern fn kuzu_timestamp_to_tm(timestamp: kuzu_timestamp_t, out_result: [*c]struct_tm) kuzu_state;
pub extern fn kuzu_timestamp_ns_from_tm(tm: struct_tm, out_result: [*c]kuzu_timestamp_ns_t) kuzu_state;
pub extern fn kuzu_timestamp_ms_from_tm(tm: struct_tm, out_result: [*c]kuzu_timestamp_ms_t) kuzu_state;
pub extern fn kuzu_timestamp_sec_from_tm(tm: struct_tm, out_result: [*c]kuzu_timestamp_sec_t) kuzu_state;
pub extern fn kuzu_timestamp_tz_from_tm(tm: struct_tm, out_result: [*c]kuzu_timestamp_tz_t) kuzu_state;
pub extern fn kuzu_timestamp_from_tm(tm: struct_tm, out_result: [*c]kuzu_timestamp_t) kuzu_state;
pub extern fn kuzu_date_to_string(date: kuzu_date_t, out_result: [*c][*c]u8) kuzu_state;
pub extern fn kuzu_date_from_string(str: [*c]const u8, out_result: [*c]kuzu_date_t) kuzu_state;
pub extern fn kuzu_date_to_tm(date: kuzu_date_t, out_result: [*c]struct_tm) kuzu_state;
pub extern fn kuzu_date_from_tm(tm: struct_tm, out_result: [*c]kuzu_date_t) kuzu_state;
pub extern fn kuzu_interval_to_difftime(interval: kuzu_interval_t, out_result: [*c]f64) void;
pub extern fn kuzu_interval_from_difftime(difftime: f64, out_result: [*c]kuzu_interval_t) void;
pub extern fn kuzu_get_version(...) [*c]u8;
pub extern fn kuzu_get_storage_version(...) u64;
...
pub const _LIBCPP_HAS_NO_MUSL_LIBC = @as(c_int, 1);
...
// /opt/homebrew/Cellar/zig/0.15.1/lib/zig/libcxx/include/__configuration/abi.h:154:9
...
pub const KUZU_HELPER_DLL_IMPORT = @compileError("unable to translate macro: undefined identifier `visibility`");
// zig-global-cache/p/N-V-__8AAETRDQLAq625_lm2DsVBcbj3vBpg5iWsfn_YBp9X/./kuzu.h:17:9
pub const KUZU_HELPER_DLL_EXPORT = @compileError("unable to translate macro: undefined identifier `visibility`");
// zig-global-cache/p/N-V-__8AAETRDQLAq625_lm2DsVBcbj3vBpg5iWsfn_YBp9X/./kuzu.h:18:9
pub const KUZU_HELPER_DLL_LOCAL = @compileError("unable to translate macro: undefined identifier `visibility`");
// zig-global-cache/p/N-V-__8AAETRDQLAq625_lm2DsVBcbj3vBpg5iWsfn_YBp9X/./kuzu.h:19:9
pub const KUZU_HELPER_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__deprecated__`");
// zig-global-cache/p/N-V-__8AAETRDQLAq625_lm2DsVBcbj3vBpg5iWsfn_YBp9X/./kuzu.h:20:9
pub const KUZU_API = KUZU_HELPER_DLL_IMPORT;
pub const KUZU_DEPRECATED = KUZU_HELPER_DEPRECATED;
pub const KUZU_DEPRECATED_EXPORT = KUZU_API ++ KUZU_DEPRECATED;
